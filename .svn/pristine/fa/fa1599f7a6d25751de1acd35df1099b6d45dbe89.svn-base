...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if(indexPath.section == 2)
    {
        ...
        if(_optionArray.count)
        {
            ...
            NSString* strTitle = [_dict objectForKey:@"sTitle"];
            label.text = [strTitle isEqual: [NSNull null]] ? @"" : strTitle;
        }
        ...
        UIImage *buttonBackgroundImage = [UIImage imageNamed:@"normal.png"];
//        UIImage *stretchedBackground = [buttonBackgroundImage stretchableImageWithLeftCapWidth:11 topCapHeight:0];
        ...
        UIImage *buttonBackgroundImageFocus = [UIImage imageNamed:@"focus.png"];
//        UIImage *stretchedBackgroundFocus = [buttonBackgroundImageFocus stretchableImageWithLeftCapWidth:11 topCapHeight:0];
        [btn setBackgroundImage:buttonBackgroundImageFocus forState:UIControlStateHighlighted];
